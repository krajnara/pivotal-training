...
import io.pivotal.workshop.repository.DirectoryRepository;

import static java.util.Arrays.asList;

@SpringBootApplication
public class BootMicroserviceApplication {

    public static void main(String[] args) {
        SpringApplication.run(BootMicroserviceApplication.class, args);
    }
